...
//so it's available everywhere in this file
using System.Data; 
...
do 
{
    if (!firstTry)
    {
        Console.WriteLine("Jag förstod inte ditt svar. Svara med siffror och icke-negativa tal!");
    }
    Console.Write("Hur gammal är du? ");
    //Change the variable ageAsString to t
    //the user input here
    //if we had declared it here it would
    //only be available inside this program
...
//if one condition in is true the rest of the same if...else if...else
//will never be run even if there are more conditions further down are true
...
{
    Console.WriteLine("Du får inte handla på Systembolaget. Men du får rösta");
}
else
{
